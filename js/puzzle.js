...
document.getElementById("scale").onchange = function() {
  //Dibujar la cantidad de cuadraditos según el valor
...
document.getElementById("puzzle").onclick = function(e) {
  ...
  if (distance(clickLoc.x, clickLoc.y, emptyLoc.x, emptyLoc.y) == 1) {
    //Distancia del cuadrado al moverse los elementos
...
function setBoard() {
  //Establecer los cuadraditos del tablero
...
function drawTiles() {
  //Dibujar los cuadraditos según el movimiento
